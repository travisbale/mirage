...
func (s *stubSessionSvc) NewSession(_, _, _, _, _ string, _ map[string]string) (*aitm.Session, error) {
	return nil, nil
}
func (s *stubSessionSvc) Update(_ *aitm.Session) error                      { return nil }
func (s *stubSessionSvc) CaptureTokens(_ *aitm.Session) error               { return nil }
