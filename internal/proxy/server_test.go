...
func TestSpoofSite_NoSpoofURL_ServesDefaultPage(t *testing.T) {
	sp := proxy.NewSpoofSite("", discardLogger())
...
func TestSpoofSite_RewritesDomainsInResponse(t *testing.T) {
	...
	sp.ServeWithTarget(rec, req, backend.URL)
...
func TestSpoofSite_StripsCORSHeaders(t *testing.T) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestSpoofSite_StripsSessionCookie(t *testing.T) {
